...
Drop this in at ``ai_experiments/core/logger.py`` and import ``get_logger`` everywhere instead
...
def _configure() -> None:
    global _configured  # noqa: PLW0603  # module-level lazy singleton: the canonical CES-74 pattern
    if _configured:
        return
